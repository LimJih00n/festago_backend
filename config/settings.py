"""
Django settings for festago project.
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-dev-key-please-change-in-production-festago-2025')
...
# Database
# Support DATABASE_URL for production (PostgreSQL, MySQL, etc.)
